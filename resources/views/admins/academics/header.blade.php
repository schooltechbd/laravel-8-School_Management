<div class="col-md-12">
    <div class="card">
        <div class="card-body">
            <!-- Nav tabs -->
            <ul class="nav nav-tabs tab-horizontal" role="tablist">
                ...
                <li class="nav-item"> <a class="nav-link {{ Request::segment('3') == "sessions" ? 'active': '' }}"  href="{{ route('sessions.index')}}" role="tab"><span class="hidden-sm-up"><i class="fa fa-plus-circle"></i></span> <span class="hidden-xs-down">{{ __('Session') }}</span></a> </li>
            </ul>
        </div>
    </div>
</div>
